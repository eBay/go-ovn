...
type Client interface {
	...
	LRSRDel(lr string, prefix string, nexthop string, output_port string, policy string) (*OvnCommand, error)
...
func (c *ovndb) LRSRDel(lr string, prefix string, nexthop string, output_port string, policy string) (*OvnCommand, error) {
	return c.lrsrDelImp(lr, prefix, nexthop, output_port, policy)
}
